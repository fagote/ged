...
<input type="text" name="name_empresa" placeholder="Nome da empresa" value="{{ $company->name_empresa ?? old('name_empresa') }}" required>
<input type="number" name="id_empresa" placeholder="ID da empresa" value="{{ $company->id_empresa ?? old('id_empresa') }}" min="1" step="1" required>
