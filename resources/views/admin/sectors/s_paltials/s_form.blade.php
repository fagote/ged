...
<input type="text" name="name" placeholder="Nome" value="{{ $sector->name_sector ?? old('name_sector') }}">
<input type="number" name="id_sector" placeholder="ID Setor" value="{{ $sector->id_sector ?? old('id_sector') }}" min="1" step="1">
