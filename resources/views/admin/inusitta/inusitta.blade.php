            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="uploaded-files">
                    ...
                    <ul class="file-system">
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 36 || Auth::user()->id_setor2 == 36 || Auth::user()->id_setor3 == 36 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 5 || Auth::user()->id_setor2 == 5 || Auth::user()->id_setor3 == 5 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 24 || Auth::user()->id_setor2 == 24 || Auth::user()->id_setor3 == 24 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 32 || Auth::user()->id_setor2 == 32 || Auth::user()->id_setor3 == 32 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 34 || Auth::user()->id_setor2 == 34 || Auth::user()->id_setor3 == 34 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 21 || Auth::user()->id_setor2 == 21 || Auth::user()->id_setor3 == 21 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 25 || Auth::user()->id_setor2 == 25 || Auth::user()->id_setor3 == 25 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 26 || Auth::user()->id_setor2 == 26 || Auth::user()->id_setor3 == 26 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 27 || Auth::user()->id_setor2 == 27 || Auth::user()->id_setor3 == 27 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 28 || Auth::user()->id_setor2 == 28 || Auth::user()->id_setor3 == 28 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 33 || Auth::user()->id_setor2 == 33 || Auth::user()->id_setor3 == 33 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 3 || Auth::user()->id_setor2 == 3 || Auth::user()->id_setor3 == 3 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 29 || Auth::user()->id_setor2 == 29 || Auth::user()->id_setor3 == 29 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 7 || Auth::user()->id_setor2 == 7 || Auth::user()->id_setor3 == 7 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 30 || Auth::user()->id_setor2 == 30 || Auth::user()->id_setor3 == 30 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 4 || Auth::user()->id_setor2 == 4 || Auth::user()->id_setor3 == 4 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 6 || Auth::user()->id_setor2 == 6 || Auth::user()->id_setor3 == 6 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 37 || Auth::user()->id_setor2 == 37 || Auth::user()->id_setor3 == 37 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 2 || Auth::user()->id_setor2 == 2 || Auth::user()->id_setor3 == 2 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 8 || Auth::user()->id_setor2 == 8 || Auth::user()->id_setor3 == 8 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 9 || Auth::user()->id_setor2 == 9 || Auth::user()->id_setor3 == 9 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 31 || Auth::user()->id_setor2 == 31 || Auth::user()->id_setor3 == 31 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 35 || Auth::user()->id_setor2 == 35 || Auth::user()->id_setor3 == 35 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 10 || Auth::user()->id_setor2 == 10 || Auth::user()->id_setor3 == 10 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 12 || Auth::user()->id_setor2 == 12 || Auth::user()->id_setor3 == 12 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 11 || Auth::user()->id_setor2 == 11 || Auth::user()->id_setor3 == 11 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 38 || Auth::user()->id_setor2 == 38 || Auth::user()->id_setor3 == 38 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 13 || Auth::user()->id_setor2 == 13 || Auth::user()->id_setor3 == 13 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 14 || Auth::user()->id_setor2 == 14 || Auth::user()->id_setor3 == 14 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 15 || Auth::user()->id_setor2 == 15 || Auth::user()->id_setor3 == 15 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 17 || Auth::user()->id_setor2 == 17 || Auth::user()->id_setor3 == 17 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 18 || Auth::user()->id_setor2 == 18 || Auth::user()->id_setor3 == 18 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 20 || Auth::user()->id_setor2 == 20 || Auth::user()->id_setor3 == 20 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 22 || Auth::user()->id_setor2 == 22 || Auth::user()->id_setor3 == 22 || 
                        ...
                        @if(Auth::check() && ((Auth::user()->id_empresa1 == 5 || Auth::user()->id_empresa2 == 5 || Auth::user()->id_empresa3 == 5 || Auth::user()->id_empresa4 == 5) && (Auth::user()->id_setor1 == 23 || Auth::user()->id_setor2 == 23 || Auth::user()->id_setor3 == 23 || 
