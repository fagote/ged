...
<a id="button1" href="{{ route('macros.create') }}">Adicionar Nova Macro</a>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$macro->name_macro}}</td>
                <td>
                    <a id="button1" href="{{ route('macros.edit', $macro->id_macro) }}">Edit</a>
                    <a id="button1" href="{{ route('macros.show', $macro->id_macro) }}">Detalhes</a>
                </td>
            </tr>
            @empty
            <tr>
                <td colspan="3">Nenhuma macro no banco</td>
            </tr>
            @endforelse
        </tbody>
    </table>
