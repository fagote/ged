                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$file->company?->name_empresa ?? 'Empresa não encrontada'}}</td>
                                <td>{{$file->sector?->name_setor ?? 'Setor não encontrado'}}</td>
                                <td>{{$file->macro?->name_macro ?? 'Macro não encontrada'}}</td>
