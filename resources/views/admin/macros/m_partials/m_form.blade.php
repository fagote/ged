...
<input type="text" name="name_macro" placeholder="Nome da macro" value="{{ $macro->name_macro ?? old('name_macro') }}" required>
<input type="number" name="id_macro" placeholder="ID da macro" value="{{ $macro->id_macro ?? old('id_macro') }}" min="1" step="1" required>
