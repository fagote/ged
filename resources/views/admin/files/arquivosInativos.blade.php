...
<a href="{{route('aguardandoAprovacao.index')}}" class="button" style="background-color: #facc00; color:#000000">Arquivos Aguardando Aprovação</a>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form class="button" action="{{route('files.ativar', $file->id)}}" method="POST">
                        @csrf
